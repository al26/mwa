...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Des 2017 pada 10.35
...
INSERT INTO `personalia` (`id`, `nama`, `jabatan`, `unsur`, `email`, `telp`, `facebook`, `twitter`, `instagram`, `is_ka`, `foto`) VALUES
(4, 'mommy shark', 'biyung', 'hiu', 'mommy@mail.xx', '0893341411414', '', '', 'mommy.shark', 'no', '1508709375-mommy-shark.JPG'),
(5, 'aaaa', 'bbbbb', 'aaaaaa', 'aa@jmail.vv', '089334113451', 'amriluthfi', '@aamri', 'amri', 'yes', '1508709647-aaaa.jpg');
