              ...
              <div class="modal-body col-xs-12">
                <form class="form-horizontal form-aspirasi" enctype="multipart/form-data" method="post" action="<?=base_url('kirim-pesan');?>">
                  <div class="form-group" style="margin: 0">
                    ...
                    <div class=""> 
                      <input type="text" class="form-control" name="nomor" placeholder="Judul Program" required>
                    </div>
                  </div>
                  <div class="form-group" style="margin: 0">
                  ...
                  <div class="modal-body col-xs-12">
                    <form class="form-horizontal form-aspirasi" enctype="multipart/form-data" method="post" action="<?=base_url('kirim-pesan');?>">
                      <div class="form-group" style="margin: 0">
                        <label class="control-label">Judul Program <span class="text-danger">*</span></label>
                        <div class=""> 
                          <input type="text" class="form-control" name="nomor" value="<?=$p->judul_program?>" required>
                        </div>
                      </div>
                      <div class="form-group" style="margin: 0">
                        <label class="control-label">Aspirasi <span class="text-danger">*</span></label>
